...
public class AWTMenuApp extends Frame implements ActionListener {


    private static final String FULL_NAME = "narame jose";
    private static final String REG_NUMBER = "24rp08520";
    ...
    private Panel contentPanel; // Holds the different 'pages'

    // --- Page Names for CardLayout ---
    ...
    public AWTMenuApp() {
        ...
        // --- 3. Content Panel Setup (Uses CardLayout) ---
        ...
        // --- 4. Window Closing Event Handling ---
    ...
    private Panel createLoginPage() {
        ...
        titlePanel.setPreferredSize(new Dimension(0, 60)); // 0 width works with BorderLayout
        ...
        leftNavArea.setPreferredSize(new Dimension(150, 0)); // Narrow width
        ...
        loginButtonSidebar.addActionListener(e -> cardLayout.show(this.contentPanel, LOGIN_PAGE)); // Switch to Login

        Button studentButton = new Button("student");
        studentButton.setFont(new Font("Arial", Font.BOLD, 14));
        studentButton.setBackground(ORANGE_BROWN.darker());
        studentButton.setForeground(Color.WHITE);
        studentButton.addActionListener(e -> cardLayout.show(this.contentPanel, STUDENT_PAGE)); // Switch to Student
        ...
        // Username
        gbc.gridx = 0; gbc.gridy = 0; gbc.anchor = GridBagConstraints.EAST; gbc.weightx = 0.4;
        ...
        // Password
        gbc.gridx = 0; gbc.gridy = 1; gbc.anchor = GridBagConstraints.EAST; gbc.weightx = 0.4;
        ...
        // Add a placeholder listener for the login button
    ...
    /**
     * Creates the Student Page content panel showing name and registration number.
     */
    private Panel createStudentPage() {
        Panel studentPanel = new Panel(new GridBagLayout());
        studentPanel.setBackground(LIGHT_BLUE.brighter()); // Use a distinct background

        // Use GridBagLayout to center the labels
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.weightx = 1.0;
    ...
    /**
     * Handles menu item clicks to switch between pages.
     */
    @Override
